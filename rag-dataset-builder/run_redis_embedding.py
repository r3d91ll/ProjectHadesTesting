...
Usage:
    python run_redis_embedding.py --source-dir /path/to/source --output-dir /path/to/output [--gpu]
"""
...
main_project_root = os.path.abspath(os.path.join(project_root, ".."))
if main_project_root not in sys.path:
    sys.path.insert(0, main_project_root)

# Import Redis modules
try:
    # Import from main project root, not from rag-dataset-builder
    sys.path.insert(0, main_project_root)  # Ensure main project root is first in path
